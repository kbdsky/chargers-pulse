...
# Official / Baseline 2026 Chargers Injury Data (Updated dynamically via news articles)
CHARGERS_OFFICIAL_INJURY_REPORT = [
    {
        ...
        "status_code": "ACTIVE",
        "status_detail": "보호대 착용 후 정상 훈련(Full Practice) 소화. 1주차 선발 출전 확정.",
    },
    {
        "player": "Joey Bosa",
        "position": "OLB",
        "injury": "Hand / Wrist (손/손목 부상)",
        "wednesday": "LP",
        "thursday": "FP",
        "friday": "FP",
        "game_status": "Active (정상 출전)",
        "status_code": "ACTIVE",
        "status_detail": "프리시즌 중 손목 보호대 착용 훈련 완료. 개막전 엣지 러시 정상 가동.",
    },
    {
        "player": "DJ Chark Jr.",
        "position": "WR",
        ...
        "game_status": "Out (결장)",
        "status_code": "OUT",
        "status_detail": "엉덩이 부상으로 훈련 불참(DNP). 1주차 결장 확정.",
    },
    {
        ...
        "status_code": "IR",
        "status_detail": "PUP(Physically Unable to Perform) 리스트 등재. 시즌 초반 결장 및 재활 전념.",
    },
    {
        ...
        "status_code": "IR",
        "status_detail": "IR(Designated to Return) 등재. 최소 4주 결장 후 복귀 타진.",
    },
    {
        ...
        "status_detail": "제한적 훈련(LP) 소화. 경기 당일 워밍업 후 최종 출전 여부 결정.",
    },
    {
        "player": "Isaiah World",
        "position": "OT",
        ...
        "thursday": "DNP",
        "friday": "DNP",
        "game_status": "Reserve / NFI",
        "status_code": "IR",
        "status_detail": "NFI 리스트로 이동하여 당분간 로스터 제외.",
    },
]
