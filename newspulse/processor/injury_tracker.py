...
CHARGERS_OFFICIAL_INJURY_REPORT = [
    {
        ...
        "status_code": "OUT",
        "status_detail": "1주차 경기 중 늑골 부상. 트레이너와 개별 재활 훈련 진행 중이며 2주차 결장 유력.",
    },
    {
        ...
        "status_code": "ACTIVE",
        "status_detail": "보호대 착용 후 정상 훈련(Full Practice) 완벽 소화. 2주차 Raiders전 선발 출전.",
    },
    {
        "player": "Joey Bosa",
        "position": "OLB",
    ...
    },
    {
        ...
        "position": "OT",
        "injury": "Knee / Ankle (무릎/발목)",
        "wednesday": "DNP",
        "thursday": "DNP",
        "friday": "DNP",
        "game_status": "Out (결장)",
        "status_code": "OUT",
        "status_detail": "2회 연속 훈련 불참(DNP). 오펜시브 라인 뎁스 변경 불가피.",
    },
    {
        ...
        "game_status": "Out (결장)",
        "status_code": "OUT",
        "status_detail": "햄스트링 통증으로 훈련 불참(DNP). 세컨더리 로테이션 조정.",
    },
    {
        "player": "DJ Chark Jr.",
        "position": "WR",
        ...
        "game_status": "Out (결장)",
        "status_code": "OUT",
        "status_detail": "엉덩이 부상으로 훈련 전면 불참(DNP).",
    },
    {
